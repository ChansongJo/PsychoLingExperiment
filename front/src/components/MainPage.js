...
function MobileContainer({children}) {
    ...
    const handleSidebarHide = () => setSidebarOpended(false);
    const handleToggle = () => setSidebarOpended(true);
        ...
        <ResponsiveContainer>
            ...
            <Segment style={{padding: '8em 0em'}} vertical>
                <Container text>
                    ...
                    <ExperimentModal trigger={<Button as='a' size='large'>I'm Still Quite Interested</Button>} />
